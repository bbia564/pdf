...
class FileSecondLogic extends GetxController {
  ...
  aboutFilePrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutFileApp(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can provide you with file storage and viewing"""),
      ],
      context: context,
    );
  }
